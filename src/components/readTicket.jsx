...
//end of pagination
  ...
  return (
    ...
    >
        <MDBRow>
          <MDBCol>
            <MDBBreadcrumb className="bg-light rounded-3 p-3 mb-4">
              ...
              <MDBBreadcrumbItem active>Phiếu xuất kho</MDBBreadcrumbItem>
              <MDBBreadcrumbItem>
      ...
      <h1 className="text-center">Phiếu xuất kho</h1>
      ...
      Tổng Phiếu xuất kho: {totalItems}
      </div>
      <div>
      {/* /*Start of Filter */ }
      <MDBInput
